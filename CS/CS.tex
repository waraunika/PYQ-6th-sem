...
\section{Pulse Modulation Systems}
  ...
  \subsection{Advanced Quantization Techniques}
    ...
    \subsubsection{Companding techniques ($\mu$ and A law companding)}
    	\begin{enumerate}
...
\section{Baseband Data Communication Systems}
  ...
  \subsection{Information Theory Fundamentals}
    \subsubsection{Introduction to information theory}
    \subsubsection{Measure of information and entropy}
    	\begin{enumerate}
    		...
    		\item A continuous signal is band limited to 5 kHz. The signal is quantized in 6 levels of a PCM system with the probabilities $\dfrac{1}{2}, \dfrac{1}{4}, \dfrac{1}{8}, \dfrac{1}{16}, \dfrac{1}{32}, \text{and} \dfrac{1}{32}$. Calculate the entropy and information rate. \hfill [5+5] (74 Ash)
    		...
    		\item A discrete source one of 6 possible symbols per 10$\mu$s statistically independent manner. The symbol probabilities are $\dfrac{1}{4}, \dfrac{1}{4}, \dfrac{1}{4}, \dfrac{1}{8}, \dfrac{1}{16}, \text{and} \dfrac{1}{16}$ respectively. Calculate symbol rate, entropy and information rate. \hfill [6] (70 Asa)
    		
    		\item A discrete source one of 5 possible symbols per 10$\mu$s statistically independent manner. The symbol probabilities are $\dfrac{1}{2}, \dfrac{1}{4}, \dfrac{1}{8}, \dfrac{1}{16}, \text{and} \dfrac{1}{16}$. Find (a) Symbol rate (b) Source entropy (c) Information rate. \hfill [3] (\bo{70 Ch})
    	\end{enumerate}
    
    \subsubsection{Symbol rates and data (bit) rates}
    \subsubsection{Shannon Hartley Channel capacity theorem}
      \begin{enumerate}
        \item With a suitable example explain Shanon-Hartley channel capacity theorem. \hfill [3] (\bo{\texttt{80 Ch}})
        
        \item Explain Shannon channel capacity theorem. \hfill [1] (\bo{71 Ch}) [2] (\bo{72 Ch})
        
        \item Write down theoretical limitations of this theorem. \hfill [3] (\bo{72 Ch, 71 Ch})
        
        \item Explain Shannon Hartley channel capacity theorem and its implication and theoretical limits. \hfill [6] (80 Ba, 75 Ash)
        \lb with examples. \hfill [8] (76 Ash)
        ...
        \item Calculate the upper limit of the channel capacity as the bandwidth of the channel (B) tends to infinity. \hfill [4] (81 Ba, 70 Asa)
        \lb Show that channel capacity 1.44S/No, when channel bandwidth is tends to infinity. \hfill [10] (80 Ba) [4] (75 Ash)
        
        \item State and explain Nyquist Channel Capacity Thereom. \hfill [8] (\bo{80 Bh})
      \end{enumerate}

    \subsubsection{Implications and theoretical limits}
  \subsection{Line Coding}
    \subsubsection{Electrical representation of binary data (line codes)}
    	\begin{enumerate}
    		\item Write short notes on: Line codes. \hfill [4] (72 Ka)
    	\end{enumerate}
    
    \subsubsection{Unipolar NRZ, bipolar NRZ, unipolar RZ, bipolar RZ}
    \subsubsection{Manchester (split phase), differential (binary RZ-alternate mark inversion) codes}
      \begin{enumerate}
        \item Define unipolar, polar, bipolar, unnipolar RZ and Manchester line codes. \hfill [2x5] (\bo{79 Ch})

        \item Consider that the bit sequence 100000000001101 is to be transmitted. Draw the resulting waveform if the sequence is transmitted using Polar RZ, Differential Manchester, HDB3 and B\&ZS, and compare their bandwidths.
        \hfill [10] (\bo{\texttt{81 Ch}})

        \item Represent the given binary sequence 110011000001 in unipolar RZ, Manchester and HDB3 encoder.
        \enter\hfill [6] (\bo{\texttt{80 Ch}})

        \item Given the binary sequence 1101010111 represent in Unipolar RZ, Bipolar NRZ, Polar NRZ and Manchester encoders. \hfill [6] (\bo{\texttt{79 Ch}})

        \item Represent using following encoders: Polar RZ, Bipolar NRZ, AMI and Manchester.
        \lb 100111010 \hfill [2+2+2+2] (\bo{\texttt{78 Ch}})
        \lb 1001101101 \hfill [1.5+1.5+1.5+1.5] (\bo{81 Bh})
        
        \item Given the binary sequence, represent it in polar NRZ, polar RZ, Manchester and AMI codes.
        \lb 1101010111 \hfill [4] (8f1 Ba)
        \lb 1011001010 \hfill [5] (\bo{70 Ch}, 73 Shr)
        \lb 1101010011 \hfill [4] (\bo{73 Ch})

        \item Draw the timing diagram of Polar NRZ, Polar RZ, Manchester and unipolar RZ for the following binary sequence 101100001000000000111. \hfill [6] (76 Ash)
