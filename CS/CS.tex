...
\section{Introduction}
  ...
  What is communnication system? \hfill [2] (\texttt{79 Ash})
  ...
  \subsection{Fundamental Concepts}
    \subsubsection{A/D sources and transmission}
      \begin{enumerate}[topsep=0pt, noitemsep]
        ...
        \item Draw the generic block diagram of Analog Communication system for half duplex mode. \hfill [3] (\texttt{80 Ash})
        ...
        \item Explain the importance of transducers, modulators and channel in Analog CS with neat and clean diagram. \hfill [6] (\texttt{79 Ash})

        \item Describe the functional digital CS working in half duplex mode and constrast it with an analog CS. \hfill [5] (\texttt{82 Ka})

        \item Draw the block diagram of digital CS. \hfill [2] (\bo{72 Ash})
    ...
    \subsubsection{Noise, Distortion and Interference}
      \begin{enumerate}[topsep=0pt, noitemsep]
        \item Mention all the communication impairments and performance parameters. \hfill [3] (\texttt{82 Ka})

        \item Define BW, SNR, SQNR, BER, ISI parameters. \hfill [5] (\texttt{81 Ash})
  ...
  \subsection{Introduction to Modulation}
      \begin{enumerate}[topsep=0pt, noitemsep]
        ...
        \lb Explain need and disadvantages of modulation. \hfill [5] (\texttt{80 Ash})
  ...
  \subsection{Review of Signals and Systems}
    ...
    \subsubsection{Imulse Response and Transfer Function of a System}
      \begin{enumerate}
        ...
        \lb Describe the impulse response of LPF. \hfill [3] (\texttt{79 Ash})
      \end{enumerate}
    ...
    \subsubsection{LTI systems}
      \begin{enumerate}[topsep=0pt]
        ...
        \item Write the properties of LTI system. \hfill [4] (\texttt{80 Ash}, \bo{68 Bh})
        ...
        \item Check whether y(t) = log{x(t)} is a linear or non-linearsystem. \hfill [5] (\texttt{82 Ka})
  ...
  \subsection{System Transformations and Properties}
    \subsubsection{Transformations on Transfer Function}
      \begin{enumerate}
        ...
        \item Construct the signal flow diagram of the system described by the following equation. \hfill [4] (\texttt{82 Ka})\\
          $$y(t) + 2 \int y(t) dt + 3 \int \int y(t) dt dt = 4 \int x(t)dt + 5 \int \int x(t) dt dt$$
      \end{enumerate}
    ...
    \subsubsection{Distortionless Transmission}
      \begin{enumerate}
        \item What is distortionless transmission? \hfill [2] (\texttt{79 Ash})
  ...
  \subsection{Special Transforms and Signal Representations}
    \subsubsection{Hilbert Transform and its Properties}
      \begin{enumerate}
        ...
        \lb Write short notes. \hfill [4] (\texttt{81 Ash}) [5] (\bo{\texttt{81 Bh}})
...
\section{Spectral Analysis}
  ...
  \subsection{Signal Energy and Power}
    \subsubsection{Energy and Power}
      \begin{enumerate}
        \item Define energy and power signal. \hfill [2] (\bo{76 Bh, 73 Bh}, 65 Ka) [4] (\texttt{80 Ash})
          \lb Differentiate. \hfill [3] (\texttt{79 Ash})
    ...
    \subsection{AC function, relationship between psdf and AC function}
      \begin{enumerate}
        \item Define psdf and express its relation with AC function. \hfill [5] (\texttt{82 Ka})
        ...
        \item Taking example of any two signals, derive auto-correlation, cross-correlation and convolution graphically. \hfill [3+3+3] (\texttt{82 Ka})

        \item What is autocorrelation and crosscorrelation of a signal? \hfill [2] (\texttt{79 Ash})

        \item Perform convolution of the following signals, by graphical method. \hfill [6] (\texttt{81 Ash})
          \begin{tikzpicture}
            \draw[->] (-0.5,0) -- (3,0) node[right] {$t$};
            \draw[->] (0,-0.5) -- (0,2) node[above] {$X_1(t)$};
            \draw[thick,red] (0,1) -- (2,1) -- (2,0);
            \node[below] at (1,0) {1};
            \node[below] at (2,0) {2};
            \node[left] at (0,1) {1};
          \end{tikzpicture}
          ...
          \begin{tikzpicture}
            \draw[->] (-0.5,0) -- (3,0) node[right] {$t$};
            \draw[->] (0,-2) -- (0,2) node[above] {$X_2(t)$};
            \draw[thick,red] (0,1) -- (1,1) -- (1,-1) -- (2,-1) -- (2,0);
...
\section{Amplitude Modulation and Demodulation}
    ...
    \subsubsection{Generation of DSB-FC AM (Balanced, Ring Modulators)}
      \begin{enumerate}
        \item Derive the expression for double tone AM. \hfill [3] (\bo{\texttt{80 Ch}}) [6] (\bo{\texttt{79 Ch}})
          \lb and draw its line spectrums. \hfill [5] (\texttt{82 Ka})
        ...
        \item Explain Ring Modulator method of generating DSB-SC signal. \hfill [5] (\bo{70 Bh})
          ...
          \lb with neat and clean diagram. \hfill [6] (\texttt{79 Ash})
  ...
  \subsection{Demodulation of AM Signals}
    ...
    \subsubsection{Square law and envelope detection of DSB-FC}
      \begin{enumerate}
        ...
        \item With the help of neat circuit diagram, explain the operation of square law detector. \hfill [6] (\texttt{82 Ka})
  ...
  \subsection{Phase Locked Loop (PLL) in AM}
    \subsubsection{PLL: basic concepts, definition, equations and applications}
      \begin{enumerate}
        \item What is PLL? \hfill [2] (\texttt{79 Ash})
  ...
  \subsection{Numericals}
    \begin{enumerate}
      \item Calculate the percentage power saved in: (i) DSB-SC (ii) SSB-SC as compared to standard AM if the modulation depth is 60\%. \hfill [2+2] (\texttt{80 Ash})

      \item Calculate the power saving mode for double side band AM signal and single side band AM signal for percentage modulation of 60\%. \hfill [6] (\texttt{79 Ash})
...
\section{Angle Modulation and Demodulation}
  ...
  \subsection{Spectral Analysis of FM}
    \subsubsection{Time domain expression for single tone modulated FM}
      \begin{enumerate}
        ...
        \item With the help of necessary mathematical expression of Bandwidth and Modulation Index, differentiate between AM and FM. \hfill [6] (\texttt{81 Ash})
      \end{enumerate}
    ...
    \subsubsection{Bessel's function properties}
      \begin{enumerate}
        \item What are the properties of Bessel function? \hfill [2] (\bo{76 Bh})
          \lb short notes on bessel function. \hfill [4] (\texttt{79 Ash})
  ...
  \subsection{Generation and Demodulation}
    \subsubsection{Generation of FM (direct and Armstrong's method)}
      \begin{enumerate}
        \item Explain the Armstrong's method for Frequency Modulation. \hfill [4] (\bo{\texttt{80 Ch}, 79 Ash}) [6] (73 Ma)
    ...
    \subsubsection{Synchronous (PLL) and non-synchronous (limiter-discriminator) demodulation}
      \begin{enumerate}
        \item What is the role of amplitude limiter in limiter discriminator method? \hfill [2] (\bo{76 Bh}, \texttt{79 Ash}, 70 Ma)
  ...
  \subsection{FM Systems and Applications}
    \subsubsection{Stereo FM: spectral details, encoder and decoder}
      \begin{enumerate}
        ...
        \lb Explain the functioning of stereo encoder and decoder in commercial FM with clear diagram. \hfill [5] (\texttt{79 Ash})
    ...
    \subsubsection{The super-heterodyne radio receivers for AM/FM}
      \begin{enumerate}
        \item What is superheterodyne AM receiver? \hfill [2] (\texttt{79 Ash})
  ...
  \subsection{Numericals}
    \begin{enumerate}
      \item A modulated signal is given by s(t) = $40 \cos(100.1 \times 10^6 \times 2\pi t + 10 \sin(15 \times 10^3 \times 2\pi t))$. Determine (i) practical bandwidth (ii) frequency sensitivity (iii) frequency deviation and (iv) modulation index. \hfil [8] (\texttt{79 Ash})
  ...
  \subsection{Source Coding}
    ...
    \subsubsection{Shannon-Fano and Huffman codes}
      \begin{enumerate}
        ...
        \item Encode 'Phoola Ko Thunga Bahera Gayo Ganga Ko Panima' using Shannon-Fano coding technique and calculate transmission efficiency. \hfill [6+2] (\texttt{81 Ash})

        \item Encode ``Ma Mare Pani Mero Desh Bachi Rahos" using Shannon-Fano codes and calculate its efficiency. \hfill [8] (\texttt{80 Ash})
        ...
        \item Encode ``Rain Rain Go To Spain" using Shannon-Fano encoder and calculate the transmission efficiency. Find the codeword if the message is received as ``Rain Rain Go Go Spain". \hfill [2+3] (\texttt{82 Ka})
...
\section{Pulse Modulation Systems}
  ...
  \subsection{Advanced Quantization Techniques}
    \subsubsection{Non-uniform quantization}
        ...
        \item Why is non-uniform quantization required? \hfill [3] (\texttt{80 Ash})
    ...
    \subsubsection{Delta Modulation: encoder, decoder}
      \begin{enumerate}
        ...
        \item Write short notes on:
          \lb Delta Modulation. \hfill [3] (\texttt{81 Ash})
          \lb Adaptive Delta Modulation. \hfill [4] (72 Ka)

        \item Compare PCM, DPCM and Delta Modulation. \hfill [3] (\bo{\texttt{79 Ch}})
        \lb Compare between PCM and DM. \hfill [1] (\bo{75 Bh})

        \item Consider a sinusoidal signal m(t) = A $\cos(\omega_m t)$ applied to a delta modulator with step seize $\Delta$. Show that the slope overload distortion will occur if > $\dfrac{\Delta}{\omega_m T_s}$. \hfill [3] (\texttt{82 Ka})
...
\section{Baseband Data Communication Systems}
    ...
    \subsubsection{Shannon Hartley Channel capacity theorem}
      \begin{enumerate}
        \item Explain Shannon-Hartley channel capacity theorem. \hfill [1] (\bo{71 Ch}) [2] (\bo{72 Ch})
          ...
          \lb with implication. \hfill [4] (\texttt{80 Ash})
          \lb with implication and theoretical limits. \hfill [6] (80 Ba, 75 Ash)
          \lb\lo with example. \hfill [8] (76 Ash)
        
        \item Write down theoretical limitations of Shannon-Hartley theorem. \hfill [2] (\texttt{82 Ka}) [3] (\bo{72 Ch, 71 Ch})
  ...
  \subsection{Line Coding}
      \begin{enumerate}
        ...
        \item Explain the aim of line coding. \hfill [2] (\texttt{80 Ash})
    	\end{enumerate}
      ...
      \begin{enumerate}
        ...
        \item For given bit sequence and requirement, draw waveform(s):\\
          \begin{tabular}{|l|c|c|c|}
            ...
            1011000010000000000 & & \checkmark & 1.5: \texttt{82 Ka} \\ \hline
            100100000111 & & \checkmark & 2: \texttt{82 Ash} \\ \hline
            100111010 & & \checkmark & 1.5: \texttt{80 Ash} \\ \hline
          \end{tabular}
      \end{enumerate}
      ...
      \begin{enumerate}
        ...
        \item For given bit sequence and requirement, draw waveform(s):\\
          \begin{tabular}{|l|c|c|c|r|}
            ...
            101100001000000000111 & \checkmark & & & 1.5: 76 Ash \\ \hline
            100111010 & \checkmark & & & 1.5: \texttt{70 Ash} \\ \hline
          \end{tabular}
      ...
      \begin{enumerate}
        ...
        \item For given bit sequence and requirement, draw waveform(s):\\
          \begin{tabular}{|l|c|c|c|c|c|r|}
            ...
            1011000010000000000 & & \checkmark & \checkmark & & & 3: \texttt{82 Ka} \\ \hline 
            100100000111 & & \checkmark & & \checkmark & & 2: \texttt{81 Ash} \\ \hline
            100111010 & \checkmark & \checkmark & & & & 3: \texttt{80 Ash}\\ \hline
          \end{tabular}
...
\section{Bandpass (Modulated) Data Communication Systems}
  ...
  \subsection{Binary Digital Modulations}
    \subsubsection{ASK, PSK, FSK, DPSK, QPSK implementation}
      \begin{enumerate}
        \item Write short notes on: ASK, PSK and FSK. \hfill [4] (\texttt{79 Ash})
  ...
  \subsection{M-ary Digital Modulations}
    \subsubsection{Quadrature amplitude modulation (QAM) systems}
      \begin{enumerate}
        ...
        \item Describe QAM and prepare constellation diagram of 16-QAM. \hfill [4] (\texttt{80 Ash})
          
        \item Define an efficient constellation diagram of a 32-QAM. \hfill [3] (\bo{\texttt{81 Ch}})

        \item Short notes on: Constellation diagram of 32-QAM \hfill [3] (\texttt{82 Ka})
      \end{enumerate}
...
\section{Random Signals and Noise in Communication Systems}
  ...
  \subsection{Noise Characterization}
    ...
    \subsubsection{Band-limited white noise}
      \begin{enumerate}
        \item Write short notes: Band limited white noise vs thermal noise. \hfill [4] (\texttt{81 Ash})
      \end{enumerate}
  ...
  \subsection{Optimum Detection and Matched Filter}
    \subsubsection{Optimum detection of a pulse in additive white noise}
      \begin{enumerate}
        ...
        \item Short notes on: Impulse response of a matched filter for an AWGN channel \hfill [3] (\texttt{82 Ka})
...
\section{Noise performance of Bandpass Communication Systems}
  ...
  \subsection{Noise in AM Systems}
    \subsubsection{Effect of noise in envelop and synchronous demodulation of DSB-FC AM}
        ...
        \item Explain the coherent detection and phase error effect of DSB Am. \hfill [4] (\texttt{79 Ash})
  ...
  \subsection{Noise in FM Systems}
    ...
    \subsubsection{Use of pre-emphasis and de-emphasis circuits in FM}
      \begin{enumerate}
        \item Explain Pre-emphasis and De-emphasis. \hfill [4+4] (\texttt{80 Ash})
...
\section{Multiplexing}
  ...
  \begin{enumerate}
    \item Write short notes: Multiplexing vs multiple access. \hfill [4] (\texttt{81 Ash})
  \end{enumerate}
  ...
  \subsection{Frequency Division Multiplexing (FDM)}
    \subsubsection{Principle of FDM}
      \begin{enumerate}
        ...
        \item Briefly explain filter and oscillator requirement in FDM. \hfill [4] (\texttt{80 Ash}) [3+3] (\texttt{79 Ash})
      \end{enumerate}

    \subsubsection{FDM in telephony and hierarchy}
      \begin{enumerate}
        \item Explain FDM hierarchy used in telephony. \hfill [3] (\texttt{79 Ash}) [5] (75 Ba) [6] (\bo{79 Ch, 75 Bh})
        ...
        \item Show that for a voice transmission, the basic data rate using PCM is 64 kbps. \hfill [4] (\texttt{80 Ash})
      \end{enumerate}
  ...
  \subsection{Time Division Multiplexing (TDM)}
    ...
    \subsubsection{Time Division Multiplexing with PCM}
      \begin{enumerate}
        \item Write short notes on: Packet vs Message switching. \hfill [3] (\texttt{82 Ka}) [4] (\texttt{80 Ash})
      \end{enumerate}
    ...
    \subsubsection{The T1 and E1 TDM PCM telephone hierarchy}
      \begin{enumerate}
        ...
        \item T1 and E1 telephony hierarchy.
          \lb Short notes. \hfill [4] (\texttt{81 Ash})
          \lb Draw \hfill [2] (\bo{\texttt{78 Ch}})
...
\section{Error control coding techniques}
  ...
  \subsection{Fundamentals of Error Control}
    ...
    \subsubsection{Hamming distance and error control capabilities}
      \begin{enumerate}
        ...
        \item Solution on: a (7, 4) polynomial cyclic Hamming code given by g(x) = 1 + x + x\super{3} \hfill [3] (\texttt{82 Ka})

        \item With a suitable aassumption for a code word of C(7, 4) show how hamming code detects an error. \hfill [8] (\texttt{81 Ash})

        \item With suitable examples, introduce CRC-3 and LBC work to correct a single bit error. \hfill [5+5] (\texttt{82 Ka})
          \lb Check whether the received code word 110111 as has error or not7. \hfill [7] (\texttt{82 Ka})\\
          (\textbf{NOTE}: \textit{I have copy pasted the question literally as it is. It is not mentioned which coding to perform. I decided to put this question as sub-question of CRC-3, in the paper its a completely new question.})

      	\item What is binary Cyclic code? \hfill [1] (70 Asa) [2] (80 Ba)
      	
        \item Construct a (7, 4) binary CRC using a generator polynomial g(x) = $x^3 + x^2 + 1$ with data vector (1011). \hfill [5] (\texttt{80 Ash})

        \item Demonstrate how CRC-4 detects two burst error. \hfill [5] (\texttt{80 Ash})
  ...
  \subsection{Convolutional Codes}
    ...
    \subsubsection{Decoding algorithms for convolutional codes}
      \begin{enumerate}
        \item Single bit error correction using Viterbi decoder \hfill [3] (\texttt{82 Ka})

        \item With suitable example of input bit stream show State Diagram, Code Tree and Trellis diagram, demonstrate how a convolutional code corrects a signle error. \hfill [6+4] (\texttt{81 Ash})
