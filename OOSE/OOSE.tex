    ...
    \subsubsection{Object Oriented Modeling}
      \begin{enumerate}
        ...
        \item Write short notes on: CRC in object modeling. \hfill [4] (\texttt{79 Ash})
          \lb Write short notes on: CRC Cards. \hfill [3] (\bo{81 Ch, 79 Ch}) [4] (\bo{78 Ch, 76 Bh})
...
\section{Structural, Behavioral and Architectural Modeling}
  ...
  \subsection{Use case Concepts}
    \begin{enumerate}
      ...
      \item Prepare teh fully labeled use cases for cash withdraw case of the banking system. \hfill [6] (\bo{74 Bh})
    \end{enumerate}
...
\section{Object Oriented Design}
  ...
  \subsection{Components of OO Design Model}
    \begin{enumerate}
      ...
      \item Write short notes on: Design Patterns and its use in OOAD. \hfill [4] (75 Ba)
