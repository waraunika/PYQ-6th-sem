...
\section{Introduction to Software and Software Engineering}
  ...
  \subsection{Introduction to software engineering}
    \begin{enumerate}
      ...
      \item Differentiate functional \& non-functional requirements. \hfill [3] (\bo{\texttt{81 Ch, 78 Ch}}) [5] (\bo{80 Ch, 79 Ch})
        \lb Explain functional and non-functional requirements with proper example of each.
        \enter\hfill [4] (\texttt{79 Ash}) [3+3] (75 Ba)
    \end{enumerate}
  ...
  \subsection{Software processes and software process models}
    \begin{enumerate}
      ...
      \item Explain SDLC in the context of OOAD/OOSE. \hfill [5] (\bo{81 Ch})
  ...
  \subsection{Requirements engineering processes}
    \begin{enumerate}
      \item Define requirement engineering process in software development. \hfill [5] (\bo{78 Ch})
        \lb Explain. \hfill [1]  (\bo{\texttt{81 Ch, 80 Ch}, 80 Ash}) [6] (\bo{\texttt{79 Ch}})
      ...
      \item Is requirement analysis the same for every software development process? Justify your answer. \hfill [5] (\texttt{82 Ka})
...
\section{Object Oriented Analysis}
  ...
  \subsection{Unified process \& UP Phases}
    \begin{enumerate}
      \item Explain iterative development in OOSE. \hfill [4] (\bo{\texttt{81 Ch, 79 Ch, 78 Ch}, 82 Ka})
...
\section{No idea where they're from}
  \begin{center}
    Note: \textit{Noticed one thing, none of these are from our subject code. So, it is possible that they are from OOAD syllabus, and not from OOSE. Soooo no need to study them}?
  \end{center}
  \begin{enumerate}
